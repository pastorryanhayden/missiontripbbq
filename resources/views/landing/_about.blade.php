<section class="w-full max-w-5xl mx-auto py-12 px-6" id="about">
        ...
        <h2 class="font-display text-2xl mt-12">Our First Trip: South Africa</h2>
         <img src="/camp_rhino.jpg" alt="South Africa" class="w-full max-w-lg h-auto mx-auto my-6">
        <p class="text-lg mt-6">Our first trip will be in March 2024 where we hope to help several missionary friends ministring in the townships in Port Elizabeth, South Africa.  I will be teaching and preaching in multiple churches and helping in their school and campground.  We need to raise about $7,000 for this trip.</p>

<div class="bg-blaze w-full p-6 rounded mt-6 mb-16">
<h3 class="font-display text-xl text-white">Goal: $7,000</h3>
<div class="bg-eggshell h-6 w-full relative mt-6 z-0">
