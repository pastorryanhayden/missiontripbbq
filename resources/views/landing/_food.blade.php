...
<h2 class="text-center text-3xl font-display my-6">Each meal comes with...</h2>
    <div class="w-full max-w-5xl mx-auto grid lg:grid-cols-4 gap-6">
        ...
        <x-food-item name="Mac & Cheese" image="/macandcheese.jpg" description="Creamy stovetop style mac and cheese like you love - only completely homemade and using real cheese.  You'll love it." />
